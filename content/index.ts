...
import FigmaNodePreviewImage from "./images/hero-img.png";
import BannerCardUserAvatar1 from "./assets/banner-card-user/avatar-1.png";
import BannerCardUserAvatar2 from "./assets/banner-card-user/avatar-2.png";
import BannerCardUserAvatar3 from "./assets/banner-card-user/avatar-3.png";
import BannerCardUserAvatar4 from "./assets/banner-card-user/avatar-4.png";
import BannerCardUserStars from "./assets/banner-card-user/stars.svg";
...
// Served from `public/` (URL path), not importable as a module.
const partnerImage = "/images/partner-withstay.svg";

// ***************avatar****************

import Avatar1 from "./images/avatar/avatar-1.svg";
import Avatar2 from "./images/avatar/avatar-2.svg";
import Avatar3 from "./images/avatar/avatar-3.svg";
import Avatar4 from "./images/avatar/avatar-4.svg";

// **************3d home ***************

import Home1 from "./images/3dhome/Studio brushed sanstorm.svg";
import Home2 from "./images/3dhome/Studio coastal milky white.svg";
