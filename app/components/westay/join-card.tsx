  ...
  {joinSteps.map((step, index) => {
    ...
    return (
      <button
        ...
        className="absolute left-0 right-0 flex min-h-[220px] cursor-pointer flex-col justify-between rounded-[20px] border border-[#E3E3E3] bg-[#F5F3ED] px-6 py-6 text-left shadow-[0_1px_0_rgba(12,27,42,0.05)] transition-[transform,box-shadow,z-index] duration-300 hover:shadow-[0_12px_30px_rgba(12,27,42,0.12)] sm:px-8 sm:py-7 lg:min-h-[250px] lg:px-10 lg:py-8 xl:px-[37px] xl:py-10"
      >
