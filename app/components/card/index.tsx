    ...
    >
      ...
      <div className="flex-col flex gap-[10px]">
        <h3
          ...
          className="section-three-card-heading font-[600] text-white transition-colors duration-300 group-hover:text-[#4DB6AC]"
        >
          {title}
        </h3>
        <p
...
export default function WeStaySection() {
  return (
    <section className="w-full bg-[#0C1B2A] py-16 sm:py-20 md:py-24 lg:py-[120px]">
