...
function TimeIcon({ size }: { size: number }) {
  return (
    ...
    >
      <path
        d="M13.3243 18.1336C13.9813 18.7906 14.8091 19.0994 15.8078 19.06C16.8064 19.0206 17.5291 18.6592 17.9759 17.9759L26.8062 4.7305L13.5608 13.5608C12.8775 14.0338 12.503 14.75 12.4373 15.7092C12.3716 16.6685 12.6672 17.4766 13.3243 18.1336ZM4.88819 25.2294C4.31002 25.2294 3.77783 25.1045 3.29164 24.8549C2.80545 24.6052 2.41781 24.2307 2.12873 23.7314C1.44543 22.4962 0.91982 21.215 0.551892 19.8878C0.183964 18.5607 0 17.1875 0 15.7684C0 13.5871 0.413919 11.5372 1.24176 9.61869C2.0696 7.70021 3.19309 6.03139 4.61224 4.61224C6.03139 3.19309 7.70021 2.0696 9.61869 1.24176C11.5372 0.413919 13.5871 0 15.7684 0C17.9234 0 19.947 0.407349 21.8392 1.22205C23.7314 2.03675 25.387 3.1471 26.8062 4.55311C28.2253 5.95912 29.3554 7.60166 30.1964 9.48072C31.0374 11.3598 31.471 13.3768 31.4973 15.5318C31.5236 16.9773 31.3593 18.3898 31.0045 19.7696C30.6497 21.1493 30.1044 22.4699 29.3686 23.7314C29.0795 24.2307 28.6918 24.6052 28.2056 24.8549C27.7194 25.1045 27.1873 25.2294 26.6091 25.2294H4.88819Z"
        fill="white"
      />
    </svg>
  );
...
/** Inner solid teal proportional to legacy 70/85 ring (~82×82 at 100 outer) */
const ACTIVE_INNER_PX = Math.round((70 / 85) * ACTIVE_OUTER_PX);
/** Inactive right step node */
...
export function StepFooter({
  ...
  /** Center first icon on the form midline — half outer ring width pulls back from content start */
    ...
    return (
      <div className="w-full pt-2 pb-6">
        <div className="relative flex items-center justify-between">
          ...
          <div
            className="relative z-10 flex shrink-0 items-center justify-center rounded-full opacity-0"
            style={{ width: SECOND_CIRCLE_PX, height: SECOND_CIRCLE_PX, backgroundColor: "#4DB6AC33" }}
            aria-hidden
          />
  ...
  return (
    <div className="flex w-full items-center gap-0 pt-2 pb-6">
      ...
      <div className="flex min-w-0 flex-1 items-center" style={{ marginLeft: -firstIconOverlap }}>
        {/* Icon 1 — FileIcon, active (100×100 outer ring) */}
        <div
        ...
        {/* Icon 2 — TimeIcon, inactive — 70×70, vertically centered with first */}
        <div
